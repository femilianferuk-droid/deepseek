"""
AI Chat Platform — Flask (всё в одном файле)
Регистрация/авторизация, чат с AI через Anthropic SDK (custom base_url),
сохранение кода в файл, таймер ответа, "Думаю..." во время генерации.

Модели: sonnet-4.6, deepseek-v4-flash, mimo-v2.5, minimax-m3
БД: PostgreSQL
...
app.config['SQLALCHEMY_DATABASE_URI'] = os.environ.get(
    'DATABASE_URL',
    'postgresql://bothost_db_06a851292493:ToKKxst8x1doT6bVcHgfjr7AV8czk0jGA86XlKI0zyo@node1.pghost.ru:15918/bothost_db_06a851292493',
)
...
AI_CLIENT = Anthropic(
    ...
    api_key="sk-smart-3XD55m5XyNjpez1edNzGkuaqvnnXs6qKm1pf5hQqHEA",
    timeout=120.0,
)
...
<div class="app">
  ...
  <form id="composer" class="composer" onsubmit="return sendMessage(event)">
    <textarea id="input" placeholder="Напишите сообщение... (Shift+Enter — новая строка)" rows="3" required></textarea>
    <div class="composer-row">
      <input id="filename" type="text" placeholder="💾 Сохранить код в файл (например bot.py) — необязательно">
